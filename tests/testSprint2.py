...
def test_data_inserted():
    ...
    connection, cursor = DatabaseStuff.open_db("test.db")
    DatabaseStuff.create_entries_table(cursor)
    test_entry = {'EntryId': '11', 'Field2': 'Dr.', 'Field3': 'Pallavi', 'Field4': 'Mathew', 'Field6': 'Software Eng -MTS', 'Field7': 'AMD',
                  'Field8': 'pallavi@amd.com', 'Field9': '', 'Field11': 'Course Project', 'Field12': '', 'Field13': '', 'Field14': '', 'Field15': '',
                  'Field16': '', 'Field17': '', 'Field113': 'Philosophy',
                  ...
                  'Field115': 'Yes', 'DateCreated': '2023-02-10 08:15:49', 'CreatedBy': 'public', 'DateUpdated': '', 'UpdatedBy': None}
